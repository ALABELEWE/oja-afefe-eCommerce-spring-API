...
public class AuthController {
    ...
    @Tag(name="Authentication APIs", description = "API for managing all authentication")
    @Operation(summary = "Sign In ", description = "API to sign in user")
    @PostMapping("/signin")
    ...
    @Tag(name="Authentication APIs", description = "API for managing all authentication")
    @Operation(summary = "Sign up ", description = "API to sign up user")
    @PostMapping("/signup")
    ...
    @Tag(name="Authentication APIs", description = "API for managing all authentication")
    @Operation(summary = "Get Username ", description = "API to get username of user")
    @GetMapping("/username")
    ...
    @Tag(name="Authentication APIs", description = "API for managing all authentication")
    @Operation(summary = "Sign Out ", description = "API to sign Out user")
    @PostMapping("/signout")
